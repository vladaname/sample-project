	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right">
				...
				<c:if test="${korisnik.uloga.nazivUloge == 'kontrolor'}">
					<li><a href="/PicaWEB/CreatePica" method="get">DODAJ</a></li>
				</c:if>
	...
	<div class="container">
		<div class="row col-md-12 custyle">
			<table class="table table-striped custab">
				...
				<tbody>
					<c:forEach var="pica" items="${listaPica }">
						<tr>
							<td>${pica.idpica }</td>
							<td>${pica.nazivPice }</td>
							<td>${pica.velicina }</td>
							<form action="/PicaWEB/UpdatePicaServlet" method="post">
								<td><input type="hidden" name="idpica"
									value="${pica.idpica }" /> <input type="number" name="cena"
									value="${pica.cena }" /></td>
								<td>
									<button class="btn btn-success active btn-md" id="slobodno"
										type="submit">Poruci</button>
								</td>
							</form>
